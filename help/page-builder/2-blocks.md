...
1. Para configurar las credenciales de la API, siga las [instrucciones](https://developers.google.com/maps/documentation/javascript/get-api-key) de la documentación de [!DNL Google Maps].
