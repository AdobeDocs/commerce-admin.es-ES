...
1. Añada una condición:
   ...
   - Complete la parte _[!UICONTROL Category is]..._ de la condición haciendo clic en el botón Más (...) y luego haga clic en el icono _Selector_ (![Icono del selector](../assets/icon-list-chooser.png)).
