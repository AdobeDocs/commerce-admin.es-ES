...
Cuando se ven desde el Administrador, los atributos son los campos que se completan al crear un producto. El tipo de entrada asignado a un atributo determina el tipo de datos que se pueden introducir y el formato del campo o control de entrada. Para el cliente, los atributos proporcionan información sobre el producto y son las opciones y los campos de entrada de datos que deben rellenarse para comprar un producto.
...
| [!UICONTROL Text Area] | Campo de entrada de varias líneas para introducir párrafos de texto, como una descripción del producto. Puede utilizar el Editor de WYSIWYG para dar formato al texto con etiquetas de HTML o introducir las etiquetas directamente en el texto. |
| [!UICONTROL Text Editor] | Un editor de texto que funcione completamente en la ubicación del atributo. |
| [!UICONTROL Date] | Muestra un valor de fecha en el [formato preferido](#date-and-time-options) y en la [zona horaria](../getting-started/store-details.md#locale-options). Los valores de fecha se pueden seleccionar de una lista o un calendario ( ![Icono de calendario](../assets/icon-calendar.png)). <br/><br/>**_Nota:_**Según la configuración de tu sistema, los usuarios de_ Admin_ pueden ingresar fechas directamente en un campo o seleccionar una fecha del calendario o lista. Para obtener información acerca de cómo especificar valores de fecha y hora, vea [Opciones de fecha y hora](#date-and-time-options). |
...
| [!UICONTROL Number] [!BADGE Solo SaaS]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Solo se aplica a los proyectos de Adobe Commerce as a Cloud Service y Adobe Commerce Optimizer (infraestructura de SaaS administrada por Adobe)."} | Campo de entrada numérico que almacena valores decimales. A diferencia del tipo de entrada **Price**, no aplica formato de moneda y acepta valores negativos. Utilice este tipo de entrada para medidas, dimensiones o especificaciones técnicas como intervalos de temperatura. |
...
| [!UICONTROL File] [!BADGE Solo SaaS]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Solo se aplica a los proyectos de Adobe Commerce as a Cloud Service y Adobe Commerce Optimizer (infraestructura de SaaS administrada por Adobe)."} | Permite cargar un archivo y asociarlo a un atributo de producto. Los tipos de archivo compatibles y el tamaño máximo de archivo están configurados en [Atributos de archivo de producto](../configuration-reference/catalog/product-file-attributes.md). Utilice este tipo de entrada para documentos como manuales de producto, hojas de especificaciones o certificados. |
...
| [!UICONTROL Page Builder] [!BADGE Solo PaaS]{type=Informative url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Se aplica solo a proyectos de Adobe Commerce en la nube (infraestructura PaaS administrada por Adobe) y a proyectos locales."} | Un área de trabajo [[!DNL Page Builder]](../page-builder/workspace.md) en la ubicación del atributo que facilita la adición de contenido atractivo a la página de producto. |

{style="table-layout:auto"}

## Opciones de fecha y hora

Puede personalizar el formato de los campos de fecha y hora y seleccionar el control de entrada que se utiliza para la entrada de datos. Los valores de fecha pueden seleccionarse de una lista desplegable o de un calendario emergente.
