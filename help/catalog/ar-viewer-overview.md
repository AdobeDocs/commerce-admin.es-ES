...
[!DNL AR Viewer] es compatible con [!DNL Magento Open Source] y Adobe Commerce. Consulte [Política del ciclo vital](https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/lifecycle-policy){target=_blank} para obtener más información sobre las versiones compatibles.
