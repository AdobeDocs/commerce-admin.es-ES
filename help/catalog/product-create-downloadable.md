...
1. Escriba el **[!UICONTROL Quantity]** del producto que está en stock.
   ...
   - Como los productos descargables no se envían, el campo **[!UICONTROL Weight]** no se utiliza. Si habilita esta característica, se convierte en un [producto simple](product-create-simple.md) y el _¿Es este producto descargable?_ no se puede usar la pestaña.
