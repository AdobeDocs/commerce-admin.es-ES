...
Consulte la [_Guía de instalación_](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/tutorials/extensions) para obtener más información sobre el proceso de instalación de la extensión.
...
>[!NOTE]
>
> Para ver una serie de vídeos de demostración de cómo un usuario agrega un modelo 3d a un producto, consulte la página [Visor de AR para Adobe Commerce](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/catalog/augmented-reality) en _Vídeos y tutoriales de Commerce_.
