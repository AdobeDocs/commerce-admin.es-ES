...
De manera predeterminada, los compradores tienen acceso al formulario de contacto mediante el _vínculo de contacto_ que aparece al pie de las páginas de la tienda. Para obtener más información sobre cómo personalizar la página de contacto, consulte la [Guía para desarrolladores de FrontEnd](https://developer.adobe.com/commerce/frontend-core/guide/themes/).
