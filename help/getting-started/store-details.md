...
1. Pase el ratón sobre el contenedor del HTML para ver la caja de herramientas y elija el icono _Configuración_ (![Configuración](../page-builder/assets/pb-icon-settings.png) ).
