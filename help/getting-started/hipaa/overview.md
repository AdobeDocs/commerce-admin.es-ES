...
|----------------|-----------|-------|
| 2.4.7-p4 y posterior | 1.2.0 | La compatibilidad con 2.4.7-p4 requiere [revisión](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-27147) |
