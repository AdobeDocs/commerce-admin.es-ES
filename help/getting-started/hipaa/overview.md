...
|----------------|-----------|-------|
| 2,4,8-p5 | 1.3.0 | La compatibilidad con 2.4.8-p5 requiere un [parche de compatibilidad](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-30555) |
| 2.4.7-p4 y versiones posteriores -p | 1.2.0 | La compatibilidad con 2.4.7-p4 requiere un [parche de compatibilidad](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27147) |
