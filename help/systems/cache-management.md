...
Encontrará información técnica adicional acerca del almacenamiento en caché de Adobe Commerce en la [Información general de caché](https://developer.adobe.com/commerce/frontend-core/guide/caching/){:target=&quot;_blank&quot;}, en la _Guía de desarrollo de Commerce Frontend_.
...
| [!UICONTROL Admin UI SDK Cache] | Almacena en caché las personalizaciones para el administrador. Consulte [Configuración de administración y pruebas](https://developer.adobe.com/commerce/extensibility/admin-ui-sdk/configuration/) en la _Guía del SDK de la IU de administración_. | `ADMIN_UI_SDK` | `admin_ui_sdk` |
