...
>[!NOTE]
> Los comerciantes de Adobe Commerce que usan Live Search, Servicio de catálogo o Product Recommendations tienen la opción de usar un [indexador de precios basado en SaaS](https://experienceleague.adobe.com/docs/commerce/price-indexer/index.html?lang=es).
