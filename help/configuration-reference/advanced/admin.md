...
description: Revise la configuración de en [!UICONTROL Advanced] &gt; [!UICONTROL Admin] de la administración de Commerce.
...
![Correos electrónicos de usuario administrador](./assets/admin-admin-user-emails.png)<!-- zoom -->

Para obtener más información sobre cómo cambiar esta configuración, consulte [Contraseña olvidada y correo electrónico restablecido](../../systems/permissions-users-all.md#forgotten-password-and-reset-emails).
...
| [!UICONTROL Forgot and Reset Email Sender] | Global | Identifica al contacto de tienda que aparece como remitente del mensaje _Contraseña olvidada_ correo electrónico. Remitente predeterminado: `General Contact`<br/>Otras opciones de remitente: `Sales Representative`, `Customer Support`, `Custom Email` |
...
Para obtener más información sobre cómo cambiar esta configuración, consulte [Cambiar la página de inicio](../../getting-started/admin-dashboard.md#change-the-startup-page) en el _Guía de introducción_.
...
| `Sales` | `Operations` | [`Quotes`](../../b2b/quotes.md) ![B2B para Adobe Commerce](../../assets/b2b.svg) <br/>[`Orders`](../../stores-purchase/orders.md)<br/>[`Invoices`](../../stores-purchase/invoices.md)<br/>[`Shipments`](../../stores-purchase/shipments.md)<br/>[`Credit Memos`](../../stores-purchase/credit-memos.md)<br/>[`Billing Agreements`](../../stores-purchase/paypal-billing-agreements.md)<br/>[`Returns`](../../stores-purchase/returns.md) ![Adobe Commerce](../../assets/adobe-logo.svg) </span><br/>[`Transactions`](../../stores-purchase/transactions.md)<br/>`Braintree Virtual Terminal` |
| `Catalog` | [`Inventory`](../../inventory-management/introduction.md) | [`Products`](../../catalog/products-list.md)<br/>[`Categories`](../../catalog/categories.md)<br/>[`Shared Catalog`](../../b2b/catalog-shared-create.md) ![B2B para Adobe Commerce](../../assets/b2b.svg) |
| `Customers` | [`All Customers`](../../customers/customers-all.md)<br/>[`Now Online`](../../customers/now-online.md)<br/>[`Customer Groups`](../../customers/customer-groups.md)<br/>[`Segments`](../../customers/customer-segments.md) ![Adobe Commerce](../../assets/adobe-logo.svg) <br/>[`Companies`](../../b2b/account-companies.md)![B2B para Adobe Commerce](../../assets/b2b.svg) |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
![URL básica de administración](./assets/admin-admin-base-url.png)<!-- zoom -->

Para obtener más información sobre la configuración de estas opciones, consulte [Configuración de la dirección URL base](../../stores-purchase/store-urls.md#configure-the-base-url) en el _Guía de experiencia de compra y tienda_.
...
Para obtener más información sobre la configuración de estas opciones, consulte [Configurar la seguridad de administración](../../systems/security-admin.md) en el _Guía de sistemas de administración_.

| Campo | [Ámbito](../../getting-started/websites-stores-views.md#scope-settings) | Descripción |
|--------------------------------------------------------|------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [!UICONTROL Admin Account Sharing] | Vista de tienda | Determina si un usuario administrador puede iniciar sesión en la misma cuenta simultáneamente desde distintos dispositivos. Opciones: <br/>**`Yes`**: permite varias sesiones activas desde la misma cuenta de administrador.<br/>**`No`** - Solo permite una sesión activa por cuenta de administrador. |
| [!UICONTROL Password Reset Protection Type] | Vista de tienda | Determina el método que se utiliza para administrar las solicitudes de restablecimiento de contraseña. Opciones: <br/>**`By IP and Email`**: la contraseña se puede restablecer en línea después de recibir una respuesta de la notificación a la dirección de correo electrónico asociada a la cuenta del administrador.<br/>**`By IP`** - La contraseña se puede restablecer en línea sin confirmación adicional. <br/>**`By Email`**: la contraseña solo se puede restablecer respondiendo por correo electrónico a la notificación que se envía a la dirección de correo electrónico asociada a la cuenta de administrador.<br/>**`None`** : solo el administrador del almacén puede restablecer la contraseña. |
...
Para obtener más información sobre la configuración de estas opciones, consulte [Tablero de administración](../../getting-started/admin-dashboard.md) en el _Guía de introducción_.
...
Para obtener más información sobre la configuración de estas opciones, consulte [Limitar visualización del producto](../../catalog/products-list.md#limit-product-display) en el _Guía de administración de catálogos_.
...
| Campo | [Ámbito](../../getting-started/websites-stores-views.md#scope-settings) | Descripción |
|-----------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| [!UICONTROL Limit Number of Products in Grid] | Global | Determina si el número de productos mostrados en la cuadrícula está limitado al _[!UICONTROL Records Limit]_valor. Opciones: `Yes` / `No` |
...
Para obtener más información sobre la configuración de estas opciones, consulte [CAPTCHA](../../systems/security-captcha.md) en el _Guía de sistemas de administración_.

| Campo | [Ámbito](../../getting-started/websites-stores-views.md#scope-settings) | Descripción |
|-------------------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [!UICONTROL Enable CAPTCHA in Admin] | Global | Habilita CAPTCHA para el inicio de sesión del administrador. Opciones: `Yes` / `No` |
| [!UICONTROL Font] | Global | Determina la fuente utilizada para mostrar el CAPTCHA. Para añadir su propia fuente, coloque el archivo de fuente en el mismo directorio que la instancia de Commerce y añada la declaración al archivo config.xml en `app/code/Magento/Captcha/etc` Fuente predeterminada:` LinLibertine` |
| [!UICONTROL Forms] | Global | Determina los formularios donde se utiliza CAPTCHA. Opciones: `Admin Login` / `Admin Forgot Password` |
| [!UICONTROL Displaying Mode] | Global | Determina cuándo aparecerá el CAPTCHA. Opciones: <br/>**`Always`**- Siempre se requiere CAPTCHA para iniciar sesión.<br/>**`After number of attempts to login`** - Muestra el [!UICONTROL Number of Unsuccessful Attempts to Login] field. Introduzca el número de intentos de inicio de sesión permitidos. Un valor de 0 (cero) es similar a establecer el Modo de visualización en Siempre. Esta opción no cubre los formularios Olvidé la contraseña y Crear usuario. Si CAPTCHA está habilitado y configurado para aparecer, siempre se incluye en el formulario.<br />**Nota**: Para rastrear el número de intentos de inicio de sesión erróneos, se cuenta cada intento de inicio de sesión con una dirección de correo electrónico y desde una dirección IP. El número máximo de intentos de inicio de sesión permitidos desde la misma dirección IP es de 1000. Esta limitación se aplica solamente cuando CAPTCHA está habilitado. |
...
Para obtener más información sobre la configuración de estas opciones, consulte [Recopilación de datos de uso](../../getting-started/admin.md#usage-data-collection) en el _Guía de introducción_.

| Campo | Ámbito | Descripción |
|------------------------------------------|--------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [!UICONTROL Enable Admin Usage Tracking] | Global | Concede permiso para que el Adobe recopile datos de uso del administrador para mejorar la experiencia de uso del _Administrador_ y productos y servicios relacionados. Al permitir la recopilación de datos, también se habilita _Guía interna del producto_ que está diseñado para ofrecer contenido interactivo como ayuda, información sobre herramientas, guías de introducción, información de incorporación, anuncios de funciones y mucho más a _Administrador_. Los administradores individuales no se identifican en los datos de uso. Opciones:<br />**`Yes`**- Permite la recopilación de datos y habilita _Guía interna del producto_.<br />**`No`** - No permite la recopilación de datos ni activa _Guía interna del producto_. |
