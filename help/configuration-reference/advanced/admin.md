...
|                                                         | `System Insights` | [`Site-Wide Analysis Tool`](https://experienceleague.adobe.com/es/docs/commerce-operations/tools/site-wide-analysis-tool/access) ![Adobe Commerce](../../assets/adobe-logo.svg) |
...
| [!UICONTROL Custom Admin URL] | Global | Especifica una dirección URL personalizada para acceder al administrador. De manera predeterminada, la URL de administración es la misma que la URL base.<br/>**Importante:** La URL de administración debe estar en la misma instalación de Commerce y tener la misma raíz de documento que la tienda. |
...
| [!UICONTROL Minimum Admin Password Length] | Global | Determina el número mínimo de caracteres necesarios para las contraseñas de administrador. El valor predeterminado es 7 y el mínimo permitido es 7. Esta configuración afecta a los cambios de contraseña de administrador, a la creación de nuevos usuarios de administrador desde la interfaz de administración y la CLI, y a las operaciones de restablecimiento de contraseña desde el administrador. |
