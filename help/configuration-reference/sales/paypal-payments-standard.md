...
>A partir del 14 de septiembre de 2019, los bancos europeos podrían rechazar los pagos que no cumplan los requisitos de [PSD 2](../../getting-started/compliance-payment-services-directive.md). No se requiere ninguna acción por parte de [!DNL PayPal Payments Standard] para cumplir con PSD2 porque PayPal se encarga de todos los requisitos.
