...
| [!UICONTROL Enable Vault CVV Reverification] | Sitio web | Cuando está habilitada, se realiza la validación de las reglas CVV configuradas en su cuenta de Braintree. Opciones: `Yes` / `No` |
...
![PayPal mediante Braintree](./assets/payment-methods-braintree-paypal-config.png){width="550" zoomable="yes"}
