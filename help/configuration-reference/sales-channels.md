...
Esta configuración está disponible cuando [[!DNL Amazon Sales Channel]](https://experienceleague.adobe.com/es/docs/discontinued/using/commerce-channels) está instalado.
