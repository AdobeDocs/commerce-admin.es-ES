...
description: Configure las opciones por producto  [!DNL Inventory Management]  y de inventario avanzado que anulan la configuración de origen y existencias globales.
