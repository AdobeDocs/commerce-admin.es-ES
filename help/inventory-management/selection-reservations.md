...
description: Aprenda cómo el algoritmo de selección de Source y las reservas mantienen la precisión de la cantidad vendible durante el cierre de compra y el envío en  [!DNL Inventory Management].
