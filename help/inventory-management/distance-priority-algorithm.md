...
description: Configure el Algoritmo de selección de Source de prioridad de distancia mediante Mapas de Google o geocódigos sin conexión para recomendar la fuente más cercana.
