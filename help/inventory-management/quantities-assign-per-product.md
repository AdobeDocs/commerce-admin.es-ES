...
description: Establezca cantidades y umbrales disponibles por origen en una página de productos para mantener la precisión de  [!DNL Inventory Management] existencias vendibles.
