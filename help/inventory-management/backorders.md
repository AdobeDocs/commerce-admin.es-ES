...
description: Configure pedidos pendientes globales y por producto en  [!DNL Inventory Management]  para vender y enviar productos cuando la cantidad disponible sea cero.
