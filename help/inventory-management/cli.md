...
description: Obtenga información acerca de los  [!DNL Inventory Management Commerce] comandos CLI para administrar los datos de inventario y las opciones de configuración.
