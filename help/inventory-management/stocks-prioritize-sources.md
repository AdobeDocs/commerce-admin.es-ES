...
description: Establezca el orden de prioridad de origen en un stock en Admin para controlar las recomendaciones del algoritmo de selección de Source durante el envío.
