...
description: Importe y exporte  [!DNL Inventory Management] asignaciones de origen y cantidades por origen por SKU mediante herramientas nativas de transferencia de datos del catálogo.
