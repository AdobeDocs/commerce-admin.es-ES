...
1. [Inicia sesión](https://www.google.com/analytics/){: target="_blank"} en la cuenta de Google Analytics de tu empresa.
...
1. Acepte la _enmienda de procesamiento de datos_.
   ...
   Los Términos de procesamiento de datos de Google Ads describen cómo Google procesa los datos y las medidas que toma para garantizar la seguridad de los datos empresariales sujetos al RGPD. Con la modificación también se mantiene un registro de sus entidades legales e información de contacto. Para [obtener más información](https://support.google.com/analytics/answer/3379636){: target="_blank"}, haga clic en el vínculo del mensaje en la parte superior de la página.
...
Para obtener más información, consulte la [Referencia de campo de Analytics.js](https://developers.google.com/analytics/devguides/collection/analyticsjs/field-reference){: target="_blank"} en la Ayuda de Google.
...
Para obtener más información, consulte [Anonimización de IP en Analytics](https://support.google.com/analytics/answer/2763052) en la Ayuda de Google.
