...
Para obtener instrucciones sobre cómo elegir entre redirecciones de término de búsqueda, reescrituras de URL, reglas de [!DNL Live Search] y enrutamiento de tienda, consulte [Redirecciones de término de búsqueda y enrutamiento de tienda](search-term-redirects.md).
