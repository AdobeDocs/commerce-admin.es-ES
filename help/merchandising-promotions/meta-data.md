---
title: Metadatos
description: Obtenga información sobre cómo introducir metadatos enriquecidos con palabras clave para mejorar la forma en que los motores de búsqueda indexan el sitio de Commerce.
...
![Configuración del producto: optimización de los motores de búsqueda](./assets/product-basic-settings-search-engine-optimization-yoga-strap.png){width="700" zoomable="yes"}
...
Si también incluye la ruta de la categoría en las direcciones URL del producto, la dirección URL canónica permanece como nombre de dominio/clave de URL del producto. Sin embargo, también se puede acceder al producto mediante su dirección URL completa, que incluye la categoría. Por ejemplo, si la clave de URL del producto es `driven-backpack` y se asigna a la categoría Gear > Bags, se puede acceder al producto mediante cualquiera de las dos direcciones URL.
...
1. Expandir ![Selector de expansión](../assets/icon-display-expand.png) el **Optimización del motor de búsqueda** sección.

   Para cambiar cualquier valor de campo, primero debe borrar la **Usar valor del sistema** después de cada campo.
...
1. Si desea que los motores de búsqueda indicen solo las páginas de categoría que utilizan la ruta de categoría completa, haga lo siguiente:
   ...
   - Establecer **Usar metaetiqueta de vínculo canónico para categorías** hasta `Yes`.

   - Establecer **Uso de la metaetiqueta de vínculo canónico para productos** hasta `No`.
...
1. Si desea que los motores de búsqueda indexen páginas de producto únicamente con el formato nombre de dominio/clave de URL de producto, haga lo siguiente:
   ...
   - Establecer **Uso de la metaetiqueta de vínculo canónico para productos** hasta `Yes`.

   - Establecer **Usar metaetiqueta de vínculo canónico para categorías** hasta `No`.
